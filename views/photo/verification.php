<div layout="row">
	<div flex class="text-center">
	      <div style="font-size: 22px; margin-top: 10px;">Verificando información</div>
	</div>
</div>
<div layout="row" style="margin-top:10px">
 ...
 <md-dialog-actions layout="row" layout-margin >
            <span flex></span>
		   <md-button class="md-raised" style="background-color: #00BCD4; color:#FFFFFF" ng-click="verificationp(array.id_register_user)">Aceptar</md-button>
